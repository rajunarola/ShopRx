...
namespace RxFair.Controllers
{
    ...
    public class ManageController : BaseController<ManageController>
    {
        ...
        public ManageController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,
            IOptions<EmailSettingsGmail> emailSettingsGmail, IErrorLogService errorLog, ILogger<ManageController> logger, IHostingEnvironment hostingEnvironment, UrlEncoder urlEncoder)
        {
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            string emailTemplate = CommonMethod.ReadEmailTemplate(_errorLog, _hostingEnvironment.WebRootPath, EmailTemplateFileList.Confirmation, GetPhysicalUrl());
